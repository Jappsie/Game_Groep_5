...
public class DodgingEnemy : HealthSystem
{
	...
	protected override void Update()			//Now overrides the Update of HealthSystem to check y pos
	{
		...
		if (Dodges && GameObject.FindGameObjectsWithTag ("PlayerBullet").Length > 0 && !dodging) {
			
			Bullet = GameObject.FindGameObjectsWithTag ("PlayerBullet") [0];
